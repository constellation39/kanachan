...
python::list simulate(
  ...
  python::object dtype,
  long const room,
  long const baseline_grade,
  python::object baseline_model,
  long const proposed_grade,
  python::object proposed_model,
  long const simulation_mode,
  long const num_simulation_sets,
  long const batch_size,
  long const concurrency,
...
std::shared_ptr<Kanachan::GameLog> test(
  python::long_ const simulation_mode,
  python::tuple const grades,
  python::object test_model,
...
try {
  ...
  auto p_test_decision_maker = std::make_shared<Kanachan::DecisionMaker>(
    python::import("torch").attr("device")("cpu"),
    python::import("torch").attr("float64"),
    test_model,
    test_model,
    1u);
