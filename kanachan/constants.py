...
EOR_NUM_TYPES_OF_SPARSE_FEATURES = 78
EOR_NUM_SPARSE_FEATURES = 8

EOR_NUM_NUMERIC_FEATURES = 6

EOR_NUM_GAME_RESULT = 4

EOR_ENCODER_WIDTH = EOR_NUM_SPARSE_FEATURES + EOR_NUM_NUMERIC_FEATURES
